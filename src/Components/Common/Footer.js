    ...
    <div className="bg-footer">
      ...
      <div className="flex flex-row items-center justify-between w-11/12 max-w-maxContent text-white mx-auto  pb-14 text-sm">
        ...
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
                ...
                <div
                  ...
                  className={` ${
                    BottomFooter.length - 1 === i
                      ? ""
                      : "border-r border-richblack-700 cursor-pointer hover:text-yellow-50 transition-all duration-200"
                  } px-3 `}
                >
          ...
          <div className="text-center">Made with ❤️ CodeHelp © 2023 LearningBuddy</div>
        </div>
      </div>
    </div>
  );
