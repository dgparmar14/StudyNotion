                ...
                return(
                    ...
                    <div key={index} className={`${index===cart.length-1 ? "border-b border-b-richblack-400" : ""} border-b border-b-richblack-400 py-7 mt-2 gap-4 flex flex-wrap flex-row`}> 
                        ...
                        <div className='flex flex-col gap-1'>
                            <div className='text-richblack-700 fomt-[500] text-[17px]'>{course?.courceName}</div>
                            <div className='text-[14px] text-richblack-900'>{course?.catagory[0]?.name}</div>
                            ...
                            <div className='text-richblack-900 text-[15px] flex gap-6'>
                                <p className='text-richblack-700'>Total Courses</p>
                                <ul className=' text-richblack-700 list-disc flex gap-5'>
                                    <li>Lesson</li>
                                    <li>Beginner</li>
                                </ul>
                            </div>
