...
function Cart() {
  ...
  return (
    <div className=''>
        <p className='text-3xl font-semibold text-black -mt-3'>My Wishlist</p>
        <p className='text-[15px] text-richblack-300 mt-5'>{totalItems} items in cart</p>
        
        {
            totalItems>0 ? (
                ...
                <div className='mx-auto mt-2  my-auto text-richblack-900 text-[18px] font-[400]'>Cart is empty</div>
            )
        }
    </div>
  )
