...
function Cart() {
  ...
  return (
    <div className=''>
        <p className='text-3xl font-semibold text-white -mt-3'>My Wishlist</p>
        ...
        
        {
            totalItems>0 ? (
                ...
                <div className='mx-auto mt-2  my-auto text-richblack-50 text-[18px] font-[400]'>Cart is empty</div>
            )
        }
    </div>
  )
