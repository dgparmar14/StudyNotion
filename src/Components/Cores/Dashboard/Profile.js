...
function Profile() {
  ...
  return (
    <div className=''>
        <p className='text-3xl font-semibold mx-5 text-white'>My Profile</p>
        <div className='md:w-7/12 mx-auto my-auto flex flex-col justify-center gap-5 mt-[2rem]'>
            ...
            <div className='flex flex-row flex-wrap justify-between bg-richblack-900 px-5 border border-richblack-500 py-3 items-center rounded-md text-richblack-200'>
                ...
                <button onClick={()=>navigate("/dashboard/settings")} className='text-[14px] flex gap-1 mt-2 md:mt-0 px-4 justify-center font-semibold h-fit py-2 items-center rounded-md text-black bg-yellow-50'>
                    <FiEdit></FiEdit>
                    Edit
                </button>
            </div>
            <div className='flex flex-wrap justify-between px-5 py-3 bg-richblack-800 border border-richblack-500 rounded-md'>
                ...
                <button onClick={()=>navigate("/dashboard/settings")} className='text-[14px] flex gap-1 px-4 justify-center font-semibold h-fit py-2 items-center rounded-md text-black bg-yellow-50'>
                    <FiEdit></FiEdit>
                    Edit
                </button>
            </div>
            <div className='flex flex-wrap justify-between items-start bg-richblack-800 rounded-md border border-richblack-500 px-5 py-4 mb-1'>
                ...
                <button onClick={()=>navigate("/dashboard/settings")} className='text-[14px] mt-2 md:mt-0 flex gap-1 px-4 justify-center font-semibold h-fit py-2 items-center rounded-md text-black bg-yellow-50'>
                    <FiEdit></FiEdit>
                    Edit
                </button>
