    ...
    <div className='flex gap-4 w-[100%]'>
        <label className='flex flex-col gap-1 w-[50%]'>
            ...
            <input type='text'
                    ...
                    className='bg-richblack-800 px-4 py-1 rounded-[8px] shadowBox'
                    required>
                </input>
        </label>
        <label className='flex flex-col gap-1 w-[50%]'>
        ...
        {/* <label className='flex flex-col gap-1 w-[100%]'>
            ...
            <div className='flex gap-4'>
                <select id='countryCode' value={formData.countryCode} required name='countryCode' onChange={changeHandler} className='bg-richblack-800 w-[20%] px-4 py-1 rounded-[8px] shadowBox'>
                    {   
                ...
                <input  type="tel"
                        ...
                        minLength={10}
                        required
                        className='bg-richblack-800 px-4 w-full py-1 rounded-[8px] shadowBox'>
                    </input>
                </div>
        ...
        <div className="w-full"> 
                    <button className="w-full py-2 bg-[#FFD60A] rounded-md mt-3 mb-1 text-richblack-900 font-semibold">Create Account</button>
        </div>
    </form>
