      ...
      <div className="mt-4 flex flex-col gap-2">
        <div className="flex justify-between px-3 items-center">
          <button
            ...
            className="w-[25px] aspect-square rounded-full flex justify-center items-center bg-richblack-900"
          >
          ...
          <button
            ...
            className="px-4 py-1 text-[14px] text-richblack-900 bg-yellow-200 rounded-md"
          >
            Add Review
          </button>
        </div>
        <div className="flex justify-between items-center px-3 mt-7 py-2 gap-1">
          <p className="text-[16px] text-richblack-5 font-[500]">
            {courseEntireData.courceName}
          </p>
        ...
        <div>
          {courseSectionData.map((section, index) => {
            return (
              ...
              >
                <div
                  className={`flex cursor-pointer justify-between items-center px-3 py-1`}
                >
                      ...
                      section.subSections.map((subSection, index) => {
                        return (
                          <div
                            ...
                            } px-3 text-[14px] text-richblack-50 py-1`}
                          >
                            <input
                              type="checkbox"
                              checked={
