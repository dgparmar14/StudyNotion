  ...
  return (
    <div>
        ...
        <section className='bg-navbarBgColor mb-32'>
            <div className='w-11/12 max-w-maxContent mx-auto mt-32 flex flex-col md:flex-row gap-32 justify-center items-center px-4 py-8'>
                <div className='md:w-[40%] flex w-[65%] flex-col gap-4'>
                    ...
                    <p className='text-[16px]  text-richblack-500'>Our e-learning platform was born out of a shared vision and passion for transforming education. It all began with a group of educators, technologists, and lifelong learners who recognized the need for accessible, flexible, and high-quality learning opportunities in a rapidly evolving digital world.</p>
                    <p className='text-[16px]  text-richblack-500'>As experienced educators ourselves, we witnessed firsthand the limitations and challenges of traditional education systems. We believed that education should not be confined to the walls of a classroom or restricted by geographical boundaries. We envisioned a platform that could bridge these gaps and empower individuals from all walks of life to unlock their full potential.</p>
                </div>
                <div>
        ...
        <section className=' bg-white'>
            <div className='w-11/12 max-w-maxContent flex flex-col md:flex-row justify-center items-center mx-auto mt-24 px-8 py-8 gap-32'>
